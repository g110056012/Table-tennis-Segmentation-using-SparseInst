...
# # ball
# register_coco_instances("ball_train", {}, "/home/yoson/SparseInst/ball_data/train/annotation/train_new.json","/home/yoson/SparseInst/ball_data/train/data")
# register_coco_instances("ball_val", {}, "/home/yoson/SparseInst/ball_data/val/annotation/val_new.json", "/home/yoson/SparseInst/ball_data/val/data")


# 桌球校隊
register_coco_instances("table-tennis_train", {}, "/home/yoson/SparseInst/official/SparseInst/table-tennis/ball_data/datasets/train/annotation/annotaions.json", "/home/yoson/SparseInst/official/SparseInst/table-tennis/ball_data/datasets/train/data")
register_coco_instances("table-tennis_val", {}, "/home/yoson/SparseInst/official/SparseInst/table-tennis/ball_data/datasets/val/annotation/annotations.json", "/home/yoson/SparseInst/official/SparseInst/table-tennis/ball_data/datasets/val/data")
            ...
            for idx, inputs in enumerate(data_loader):
                ...
                if idx % 1 == 0:
                    print("process: [{}/{}] fps: {:.3f}".format(idx,
                                                                len(data_loader), 1/np.mean(durations[2:])))

                # print("process: [{}/{}] fps: {:.3f}".format(idx,
                #                                                 len(data_loader), 1 / (np.mean(durations[-1]) / count )  ))
